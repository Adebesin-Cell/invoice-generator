        ...
        <ul>
          <li>
            ...
            <ul class='side-menu__sub-open'>
              ...
              <li>
                <a
                  href='side-menu-light-dashboard-overview-4.html'
                  class='side-menu'
                >
                  <div class='side-menu__icon'>
                    {" "}
        ...
        <div class='relative'>
          <div class='grid grid-cols-12 gap-6'>
            <div class='col-span-12 xl:col-span-9 2xl:col-span-9 z-10'>
              <div class='mt-6 -mb-6 intro-y'></div>
              <div class='mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y'>
                <div class='col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left'>
                  ...
                  <div class='2xl:flex mt-5 mb-3'>
                    ...
                    <div class='mt-5 2xl:flex 2xl:justify-center 2xl:mt-0 2xl:-ml-20 2xl:w-14 2xl:flex-none 2xl:pl-2.5'>
                      <div
                        class='font-medium inline-flex bg-success text-white rounded-full px-2 py-1 text-xs 2xl:text-sm 2xl:p-0 2xl:text-success 2xl:bg-transparent 2xl:flex items-center tooltip cursor-pointer 2xl:justify-center'
                ...
                <div class='row-start-2 md:row-start-auto col-span-12 md:col-span-4 py-6 border-black border-opacity-10 border-t md:border-t-0 md:border-l md:border-r border-dashed px-10 sm:px-28 md:px-5 -mx-5'>
                  ...
                  <div class='mt-6'>
                    <canvas id='report-bar-chart-1' height='290'></canvas>
                  </div>
                </div>
                <div class='col-span-12 sm:col-span-6 md:col-span-4 py-6 border-black border-opacity-10 border-t sm:border-t-0 border-l md:border-l-0 border-dashed -ml-4 pl-4 md:ml-0 md:pl-0'>
                  <ul
                    class=' nav nav-pills w-3/4 2xl:w-4/6 bg-slate-200 dark:bg-black/10 rounded-md mx-auto p-1 '
                    role='tablist'
                  >
                    <li
                      id='active-users-tab'
              ...
              <div class='grid grid-cols-12 gap-6 relative intro-y'>
                <div class='col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6'>
                  <div class='flex items-center flex-wrap lg:flex-nowrap gap-3'>
                    ...
                    <div class='py-1 px-2.5 rounded-full text-xs bg-slate-300/50 dark:bg-darkmode-400 text-slate-600 dark:text-slate-300 cursor-pointer truncate'>
                      180 Campaign
                    </div>
                  </div>
                  <div class='px-10 sm:px-0'>
                    <canvas
                      class='simple-line-chart-3 mt-8'
                      height='110'
                    ></canvas>
                  </div>
                </div>
                <div class='col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6'>
                  ...
                  <div class='flex items-center justify-center mt-10'>
                    <div class='text-right'>
                      ...
                      <div class='truncate mt-1 text-slate-500'>
                        Active Lenders
                      </div>
                    </div>
                ...
                <div class='col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6'>
                  ...
                  <div class='px-10 sm:px-0'>
                    <canvas
                      class='simple-line-chart-4 mt-8'
                      height='110'
                    ></canvas>
                  </div>
                </div>
                  ...
                  <div class='flex flex-wrap gap-3'>
                    <div class='mr-auto'>
                      ...
                      <div class='text-white relative text-2xl font-medium leading-5 pl-4 mt-3.5'>
                        {" "}
                        <span class='absolute text-xl top-0 left-0 -mt-1.5'>
                          $
                        </span>{" "}
                        479,578.77{" "}
                      </div>
                ...
                <div class='report-box-4__content xl:min-h-0 intro-x'>
                  <div class='max-h-full xl:overflow-y-auto box mt-5'>
                    <div class='xl:sticky top-0 px-5 pt-5 pb-6'>
                      ...
                      <ul
                        class=' nav nav-pills border border-slate-300 dark:border-darkmode-300 border-dashed rounded-md mx-auto p-1 mt-5 '
                        role='tablist'
                      >
                        <li
                          ...
                          <div class='flex'>
                            <div class='w-10 h-10 image-fit zoom-in'>
                              <img
                                ...
                                src='dist/images/preview-1.jpg'
                                title='Uploaded at 30 November 2020'
                              />
                            </div>
                            <div class='w-10 h-10 image-fit zoom-in -ml-5'>
                              <img
                                ...
                                class='tooltip rounded-full'
                                src='dist/images/preview-1.jpg'
                                title='Uploaded at 22 September 2022'
                              />
                            </div>
                            <div class='w-10 h-10 image-fit zoom-in -ml-5'>
                              <img
                          ...
                          <div class='flex'>
                            <div class='w-10 h-10 image-fit zoom-in'>
                              <img
                                ...
                                class='tooltip rounded-full'
                                src='dist/images/preview-5.jpg'
                                title='Uploaded at 18 April 2022'
                              />
                            </div>
                            <div class='w-10 h-10 image-fit zoom-in -ml-5'>
                              <img
                                ...
                                title='Uploaded at 26 October 2020'
                              />
                            </div>
                            <div class='w-10 h-10 image-fit zoom-in -ml-5'>
                              <img
                          ...
                          <div class='flex'>
                            ...
                            <div class='w-10 h-10 image-fit zoom-in -ml-5'>
                              <img
                                ...
                                class='tooltip rounded-full'
                                src='dist/images/preview-5.jpg'
                                title='Uploaded at 22 January 2021'
                              />
                            </div>
                            <div class='w-10 h-10 image-fit zoom-in -ml-5'>
                              <img
                          ...
                          <div class='flex'>
                            ...
                            <div class='w-10 h-10 image-fit zoom-in -ml-5'>
                              <img
                                ...
                                class='tooltip rounded-full'
                                src='dist/images/preview-14.jpg'
                                title='Uploaded at 17 February 2021'
                              />
                            </div>
                          </div>
                        </td>
