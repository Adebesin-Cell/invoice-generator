      ...
      <div className={styles.view__wrapper}>
        ...
        <form action='' className={styles.form}>
          <div className={styles.form__group}>
            ...
            />
            <label htmlFor='product-image' className={styles.form__customLabel}>
          ...
          <div className={`${styles.form__group} ${styles["form__group--lg"]}`}>
            <label htmlFor='product-description' className={styles.form__label}>
              Product Description
            </label>
            <textarea
